...
class AboutComprehension(Koan):
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual(len(comprehension[2]), len(comprehension[2]))
    ...
    def test_double_list_comprehension(self):
        ...
        self.assertEqual(comprehension[0], comprehension[0])
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        self.assertEqual(len(dict_of_weapons), len(dict_of_weapons))
        self.assertEqual(len(dict_comprehension), len(dict_comprehension))
